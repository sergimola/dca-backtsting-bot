...
export class SweepService {
  ...
  private buildGeneratedConfig(
    ...
    return {
      ...
      stop_loss_enabled: definition.fixedParams.stop_loss_enabled ?? false,
      stop_loss_percent: params['stop_loss_percent'] ?? '0',
      stop_loss_baseline: definition.fixedParams.stop_loss_baseline ?? 'average_entries',
      stop_loss_timeout_minutes: parseInt(params['stop_loss_timeout_minutes'] ?? '0', 10),
